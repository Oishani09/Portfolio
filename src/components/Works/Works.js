  ...
  return (
    <section id="Works">
        <h2 className="WorkTitle"><Typewriter
            ...
            /></h2>
        <span className="workDescription"><Typewriter
                onInit={(typewriter) => {
                    typewriter
                        .typeString("Specialised in UI/UX Designing")
                        .pauseFor(10)
                        .deleteAll()
                        .typeString("AND")
                        .deleteAll()
                        .typeString("Responsive Development")
                        .start();
                }}
            /></span>
        <h2 className="heading">UI/UX Designs</h2>
        ...
        <h2 className="heading2">Frontend Projects</h2>
